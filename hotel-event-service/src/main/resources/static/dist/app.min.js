...
!function(a){"use strict";a.factory("HotelDealsService",["$http",function(a){function b(){this.url="/hotels"}return b.prototype={getHotelDeals:function(b){return a({method:"GET",url:this.url,params:b}).then(function(a){return $.map(a.data.result,function(a){return{name:a.name,image:a.image,priceFormatted:a.price,starRating:parseInt(a.starRating,10),guestRating:a.guestRating,tripAdvisorRating:a.tripAdvisorRating,url:a.url}})})}},new b}])}(window.services);
