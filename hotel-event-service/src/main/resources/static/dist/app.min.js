...
!function(a){"use strict";a.factory("EventsService",["$http",function(a){function b(){this.url="../mocks/events.json"}return b.prototype={getEvents:function(b){return a({method:"GET",url:this.url,params:b}).then(function(a){return $.map(a.data,function(a){return{name:a.city+", "+a.countryCode,image:a.cityImageUrl,price:a.minPrice,url:a.url}})})}},new b}])}(window.services);
!function(a){"use strict";a.factory("HotelDealsService",["$http",function(a){function b(){this.url="../mocks/hotels.json"}return b.prototype={getHotelDeals:function(b){return a({method:"GET",url:this.url,params:b}).then(function(a){return $.map(a.data.result,function(a){return{name:a.name,image:a.image,price:a.price,url:a.url}})})}},new b}])}(window.services);
!function(a){"use strict";a.factory("TopArtistsService",["$http",function(a){function b(){this.url="../mocks/top-artists.json"}return b.prototype={getArtists:function(b){return a({method:"GET",url:this.url,params:b}).then(function(a){return $.map(a.data,function(a){return{id:a.id,name:a.name,image:a.picture}})})}},new b}])}(window.services);