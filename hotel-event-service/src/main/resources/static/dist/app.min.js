...
!function(a){"use strict";a.factory("TopArtistsService",["$http",function(a){function b(){this.url="/artists"}return b.prototype={getArtists:function(b){return a({method:"GET",url:this.url,params:b}).then(function(a){return $.map(a.data,function(a){return{name:a.name,image:a.picture}})})}},new b}])}(window.services);